...
def main():
    ...
    for cat,label in labels.items():
        ...
        lines += [f'### {label}','',f'Coverage: **{len(good)} / {total} configured lenders currently verified**','','| Rank | Lender | Starting Rate | Conditions | Type | Verification | Last Verified | Source |','|---:|---|---:|---|---|---|---|---|']
