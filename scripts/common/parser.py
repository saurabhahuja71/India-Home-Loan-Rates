...
def explicit(lender, url, row, rate_min, rate_max=None, column='Advertised starting rate', conditions='Resident retail home-loan eligibility applies', credit_score_min=None, benchmark_type=None, benchmark_value=None, source_type='HTML'):
    return {'lender':lender,'category':None,'product':'HOME_LOAN','rate_type':'floating','rate_min':rate_min,'rate_max':rate_max if rate_max is not None else rate_min,'borrower_type':'resident retail borrower','credit_score_min':credit_score_min,'credit_score_max':None,'loan_amount_min':None,'loan_amount_max':None,'ltv_min':None,'ltv_max':None,'benchmark_type':benchmark_type,'benchmark_value':benchmark_value,'spread':None,'effective_date':None,'verification_status':'LIVE_VERIFIED','source_url':url,'source_type':source_type,'source_table':'Explicit HOME_LOAN source table or heading','source_row':row,'rate_source_column':column,'conditions':conditions,'last_verified':None,'collection_timestamp':None}
